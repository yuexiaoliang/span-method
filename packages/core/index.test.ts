...
describe('Testing getCellSpanByTableSpan', () => {
  it('normal.', () => {
    ...
    expect(getCellSpanByTableSpan(tableSpan, 1, 1)).toEqual([1, 3]);
    expect(getCellSpanByTableSpan(tableSpan, 1, 2)).toEqual([1, 3]);
    expect(getCellSpanByTableSpan(tableSpan, 1, 3)).toEqual([1, 1]);
    expect(getCellSpanByTableSpan(tableSpan, 2, 1)).toEqual([1, 0]);
    expect(getCellSpanByTableSpan(tableSpan, 2, 2)).toEqual([2, 0]);
    expect(getCellSpanByTableSpan(tableSpan, 2, 3)).toEqual([0, 2]);
  });
});
